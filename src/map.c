...
/*   Updated: 2019/05/14 00:02:09 by ubartemi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_check_and_place(char **map, int j, int i, t_list **current_list)
{
	int count;
	int *x;
	int *y;
...
void	ft_clean_tetramin(char **map, int j, int i, t_list **current_list)
{
	int count;
	int *x;
	int *y;
