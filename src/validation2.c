...
/*   Updated: 2019/05/14 00:02:18 by ubartemi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*ft_create_tetramin(char *one_square_str, int counter_letter)
{
	int		i;
	int		j;
	t_list	*new_elem;
...
int		ft_validation(char *tetramins, t_list **begin, int counter_letter)
{
	int		i;
	char	*one_square_str;
	t_list	*tmp;
